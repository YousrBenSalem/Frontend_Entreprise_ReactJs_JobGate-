  ...
  <div className="content-page">
    <div className="container-fluid">
          ...
          <div className="card car-transparent">
            <div className="card-body p-0">
              <div className="profile-image position-relative">
                <img src="../assets/images/page-img/profile.png" className="img-fluid rounded w-100 h-50" alt="profile-image" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="row m-sm-0 px-3">            
        <div className="col-lg-12 card-profile">
          <div className="card card-block card-stretch card-height">
            <div className="card-body">
              <div className="d-flex align-items-center mb-3">
                <div className="profile-img position-relative">
                      <img src={logo ? `http://localhost:3000/file/${logo}` :"../assets/images/user/1.jpg"} className="img-fluid rounded avatar-110" alt="profile-image" />
                </div>

                <div className="ml-3 ">
                  <h4 className="mb-1">{user.name}</h4>
                  <p className="mb-2">{user.secteur}</p>
              ...
              <ul className="list-inline p-0 m-0">
                <li className="mb-2">
                  <div className="d-flex align-items-center">
                    ...
                    <p className="mb-0">{user.adresse}</p>   
                  </div>
                </li>
